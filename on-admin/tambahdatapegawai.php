...
if(isset($_POST['simpan'])){
    ...
    $save=mysqli_query($koneksi, "INSERT INTO pegawai (id,Nama,Alamat,Tugas)
    values ('','$Nama','$Alamat','$Tugas')");
    if($save){ //jika simpan berhasil maka muncul pesan dan menuju ke halaman produk
        echo "<script>alert('Data Pegawai Berhasil disimpan !');document.location='datapegawai.php'</script>";
    }
}
}
    ?>
 ...
 <div class="outter-form-login">
            ...
            <h3 style="padding-top: 20px; color: black; font-family: Arial black; font-size:20px; padding-bottom: 20px;" class="text-center title-login">Masukkan Data Pegawai</h3>
